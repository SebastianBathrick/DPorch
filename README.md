# DPorch
DPorch is a distributed pipeline framework written in C# for building configurable, TCP-connected data-processing pipelines using simple JSON configs and user-generated Python scripts.
